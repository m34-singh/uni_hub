...
# Load environment variables from a .env file (useful in Docker)
load_dotenv()
...
if "*" in ALLOWED_HOSTS:
    ALLOWED_HOSTS = ["*"]  # Ensure wildcard works correctly
...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "templates"],  # Allow custom templates folder
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
# Ensure Django finds additional static files
